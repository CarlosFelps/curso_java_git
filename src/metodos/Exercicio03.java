...
public class Exercicio03 {
    // CRIE UMA PEQUENA CALCULADORA DE ADIÇÃO E SUBTRAÇÃO

    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        Double numeroEsqueda = informeNumero(scanner);
        ...
        Double resultado = realizarCalculo(operacao, numeroEsqueda, numeroDireita);
