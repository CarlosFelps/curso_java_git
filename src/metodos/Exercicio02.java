...
public class Exercicio02 {
    ...
    public static void main(String[] args) {
        ...
        String[] cursos = new String[] { "Java EE", "Spring", "Java OO Avançadp" };

        imprimir("Escolha dentre os cursos abaixo: ");

        iterarEExibirPosicoesDoVetorString(cursos);

        imprimirEContinuarMesmaLinha("O curso que você deseja é: ");
        ...
        imprimir("Escolha dentre as formas de pagamaento abaixo: ");
